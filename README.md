...
The config must specify the `plugins` that should be loaded and a description of the pipelines to run.
...
## Example
A common pipeline pattern is to first create some optimization problem like a TSP graph, mapping the problem to a QUBO formulation, and solving it on a quantum annealer.
